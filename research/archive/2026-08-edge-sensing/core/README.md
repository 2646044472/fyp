...
| [`16-research-first-direction-set.md`](16-research-first-direction-set.md) | Current one-palmprint plus three non-palmprint directions, each framed as a falsifiable research question |
| [`17-research-direction-index.md`](17-research-direction-index.md) | Entry point, file roles, and active decision questions for the current direction-selection cycle |
| [`18-tta-without-ground-truth-state.md`](18-tta-without-ground-truth-state.md) | Current state and novelty gate for unlabeled TTA trigger, acceptance, and rollback |

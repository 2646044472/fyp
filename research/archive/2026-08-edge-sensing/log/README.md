...
| [`43-common-cause-fusion-novelty-audit.md`](43-common-cause-fusion-novelty-audit.md) | Common-cause degradation, false consensus, and multimodal safety boundary |
| [`44-edge-native-risk-audited-cascade.md`](44-edge-native-risk-audited-cascade.md) | Risk-audited cascade sensing under strict edge budgets |
| [`45-adaptive-sensing-expansion-validation.md`](45-adaptive-sensing-expansion-validation.md) | Adaptive-sensing candidate expansion, direct-neighbor validation, and falsifiable protocol |
| [`46-edge-sensing-alternatives-audit.md`](46-edge-sensing-alternatives-audit.md) | Edge-sensing alternatives ranked by story, novelty boundary, and hardware gates |
| [`47-broader-edge-sensing-scan.md`](47-broader-edge-sensing-scan.md) | Broader edge-sensing scan and exclusion of crowded third-direction candidates |
| [`48-tta-trigger-accept-rollback-discovery.md`](48-tta-trigger-accept-rollback-discovery.md) | Primary-paper audit of unlabeled TTA trigger, acceptance, rollback, and their identifiability boundary |

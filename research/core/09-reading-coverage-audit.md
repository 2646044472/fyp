...
| 证据账本条目 | 78 | 只收入会改变题目、协议、指标或范围的资料，并新增 Bob Zhang/PAMI 研究地图、OFTTA、PhenoProfiler、missing-view medical 和复原/异常代表作边界。 |
| 已查看关键章节的原始/官方资料 | 约 78 | 在原有掌纹/PAD/edge/标准资料基础上，新增 PAMI 官方研究线与完整发表列表、OFTTA 全文与官方代码、PhenoProfiler Nature Communications 全文/Zenodo 入口、fatty-liver missing-view PubMed/ScienceDirect 资料、QFormer 官方全文页、ODS-SAM 官方全文页、UPformer PubMed 摘要、Voice-AttentionNet 期刊页面、TongueNet/舌象方向元数据等。部分只能取得摘要/官方元数据；未把 GPU/医疗私有数据/研究组网页描述当作当前 FYP 实证。 |

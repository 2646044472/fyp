...
证据账本目前有 110 个会改变选题、协议或边界的条目；其中约 110 个关键原始/官方资料被查看，2 篇综述做了逐段精读。这里的“查看”包括全文关键章节、官方摘要、代码 README 或数据卡；并不把摘要阅读写成完整复现。第二轮审计发现 2026-08 的 GBU-Palm 已覆盖掌纹多环境 RGB-NIR 视频 PAD 的大部分原先切口，故 P 已改为条件性系统协议。

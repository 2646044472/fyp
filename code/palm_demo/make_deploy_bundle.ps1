...
try {
    $paths = @(".gitignore", "BASELINES.md", "connect_pi.ps1", "HEADLESS_FIRST_BOOT.md", "USB_C_DIRECT_SETUP.md", "install_pi.sh", "install_usb_offline.sh", "run_palm_demo.sh", "enable_ssh_remote.sh", "palm_demo.py", "PI5_SAFETY_CHECKLIST.md", "OFFLINE_RESOURCES.md", "SSH_REMOTE.md", "README.md", "requirements-dev.txt", "offline_wheels", "tools", "vendor", "windows")
